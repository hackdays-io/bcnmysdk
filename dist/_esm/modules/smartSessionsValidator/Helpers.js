import { encodeAbiParameters, encodePacked, pad, toBytes, toHex } from "viem";
import { SIMPLE_SESSION_VALIDATOR_ADDRESS, SMART_SESSIONS_ADDRESS, TIMEFRAME_POLICY_ADDRESS, UNIVERSAL_ACTION_POLICY_ADDRESS } from "../../constants/index.js";
import { UniActionPolicyAbi } from "../../constants/abi/index.js";
...
export const isPermissionEnabled = async ({ client, accountAddress, permissionId }) => client.readContract({
    address: SMART_SESSIONS_ADDRESS,
    abi: SmartSessionAbi,
 ...
 */
export const toSpendingLimitsPolicy = (params) => {
    return {
 ...
 */
export function zipSessionData(sessionData) {
 ...
 */
export function unzipSessionData(zippedData) {
